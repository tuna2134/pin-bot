...
async fn pin(
    ...
    match check {
        ...
        Err(_) => {
            ...
            sqlx::query!("INSERT INTO Message VALUES($1, $2, $3)", channel_id, msg.content, author_id)
...
async fn all_event_handler(ctx: &serenity::Context, event: &poise::Event<'_>, data: &Data) -> Result<(), Error> {
    match event {
